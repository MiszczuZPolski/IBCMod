...
def main():
    ...
    print("""
  ######################################
  # ibc Development Environment Setup #
  ######################################

  This script will create your ibc dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your ibc project folder:
    [Arma 3 installation directory]\\{} => ibc project folder
    P:\\{}                              => ibc project folder
